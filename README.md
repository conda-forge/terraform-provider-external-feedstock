About terraform-provider-external-feedstock
===========================================
...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/terraform-provider-external-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/terraform-provider-external-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
      ...
      <details>
        ...
        <table>
          ...
          <tbody><tr>
              ...
              <td>
                <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=2017&branchName=main">
                  <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/terraform-provider-external-feedstock?branchName=main&jobName=osx&configuration=osx%20osx_64_" alt="variant">
                </a>
              </td>
            </tr>
          </tbody>
...
pixi add terraform-provider-external
# for installing globally
pixi global install terraform-provider-external
```
...
It is possible to list all of the versions of `terraform-provider-external` available on your platform:
...
```
pixi search terraform-provider-external --channel conda-forge
```
